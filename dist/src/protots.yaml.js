...
var UserDataNotice = (function (_super) {
    ...
    function UserDataNotice() {
        var _this = _super.apply(this, arguments) || this;
        _this.buffer = [MessageId.UserDataNotice, ""];
        return _this;
    }
...
var MatchingSuccessRsp = (function (_super) {
    ...
    function MatchingSuccessRsp() {
        var _this = _super.apply(this, arguments) || this;
        _this.buffer = [MessageId.MatchingSuccessRsp, "", [""]];
        return _this;
    }
...
var GetWalletReq = (function (_super) {
    ...
    function GetWalletReq() {
        var _this = _super.apply(this, arguments) || this;
        _this.buffer = [MessageId.GetWalletReq, 0, 0];
        return _this;
    }
...
var TestObjectReq = (function (_super) {
    ...
    function TestObjectReq() {
        var _this = _super.apply(this, arguments) || this;
        _this.buffer = [MessageId.TestObjectReq, { "num": 1 }, [{ "str": "", "subArray": [0], "subObj": { "num": 1 } }], null];
        return _this;
    }
